...
public class Method3 extends HttpServlet {
    ...
    public void multiplication(int num1, int num2, boolean flag, PrintWriter pw) {
    ...
    public void multiplication(boolean flag, PrintWriter pw) {
        multiplication(5, 8, flag, pw);
    }
